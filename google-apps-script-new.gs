...
const OLD_SHEET_NAME = 'Submissions_OLD'; // Renamed old sheet
const KART_OVERVIEW_SHEET = 'Kart_Overview'; // New main tracking sheet
const ERROR_LOG_SHEET = 'Error_Log'; // New problems tracking sheet
const SUBMISSIONS_SUMMARY_SHEET = 'Submissions_Summary'; // New weekly summary sheet
